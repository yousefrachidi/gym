  ...
  return (
    <section id="pricing" className="py-24 bg-[#111111]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Pack Duo */}
        <div className="bg-[#1a1a1a] border border-[#b5cc2e]/30 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 mb-8">
            ...
            >
              {plan.badge && (
                <div className="absolute top-5 right-5">
                  <div className="bg-red-600 text-white text-xs font-black px-3 py-1 rounded-full rotate-12 shadow-lg">
                    {plan.badge}
                  </div>
                </div>
              )}
